       ...
       <script>
           ...
           $("#exampleInputUser1").blur(function () {
               ...
               if (name.length == 0) {
                   ...
                   $('#exampleInputUser1').after('<h6 class="red" style="color:red"><small>utilisateur obligatoire</small></h6>');
               ...
               $("#exampleInputPassword1").blur(function () {
                   ...
                   if (name.length == 0) {
                       ...
                       $('#exampleInputPassword1').after('<h6 class="red" style="color:red"><small>mot de passe obligatoire</small></h6>');
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5" style="border-radius: 30px;margin-top: -90px; height:700px;" >
                <div class="brand-logo">
                  <img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/Atb39logojhk.png" style="width: 100px;margin-left: 100px;margin-top: -40px;"/>
                </div;
                  <div id="logo">
                ...
                <form class="pt-3" id="form1" runat="server" >  
                  ...
                  <div class="mt-3">  
                        <asp:Button id="loginnn" runat="server" Text="Se connecter"  class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" OnClick="klik" />
